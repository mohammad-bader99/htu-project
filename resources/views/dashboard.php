...
<div class="text-center align-middle d-flex flex-column" style="font-family: Lucida Console, Courier, monospace;">
    <div class="text-center">
        ...
        <h1 class="border-bottom border-3 w-50 text-white" style="position: absolute;top: 12rem;left:25rem"><i class="fa-sharp fa-solid fa-house"></i> HTU Point of Sale</h1>
    </div>
    <div class="my-2">
            <h1 class="my-5">Welcome Back: <?=$_SESSION['user']['display_name']?></h1>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body mt-5">
                            <h5 class="card-title">Name: <?=$_SESSION['user']['display_name']?></h5>
